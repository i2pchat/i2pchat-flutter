...
import 'package:foss_wallet/src/screens/anonpay_details/anonpay_details_page.dart';
import 'package:foss_wallet/src/screens/buy/webview_page.dart';
import 'package:foss_wallet/src/screens/dashboard/desktop_dashboard_page.dart';
import 'package:foss_wallet/src/screens/dashboard/desktop_widgets/desktop_sidebar_wrapper.dart';
import 'package:foss_wallet/src/screens/dashboard/desktop_widgets/desktop_wallet_selection_dropdown.dart';
import 'package:foss_wallet/src/screens/dashboard/widgets/transactions_page.dart';
import 'package:foss_wallet/src/screens/receive/anonpay_invoice_page.dart';
import 'package:foss_wallet/src/screens/receive/anonpay_receive_page.dart';
import 'package:foss_wallet/src/screens/settings/display_settings_page.dart';
import 'package:foss_wallet/src/screens/settings/other_settings_page.dart';
import 'package:foss_wallet/src/screens/settings/privacy_page.dart';
import 'package:foss_wallet/src/screens/settings/security_backup_page.dart';
import 'package:foss_wallet/src/screens/ionia/cards/ionia_custom_redeem_page.dart';
import 'package:foss_wallet/src/screens/ionia/cards/ionia_gift_card_detail_page.dart';
import 'package:foss_wallet/src/screens/ionia/cards/ionia_more_options_page.dart';
import 'package:foss_wallet/src/screens/settings/connection_sync_page.dart';
import 'package:foss_wallet/src/screens/setup_2fa/modify_2fa_page.dart';
import 'package:foss_wallet/src/screens/setup_2fa/setup_2fa_qr_page.dart';
import 'package:foss_wallet/src/screens/setup_2fa/setup_2fa.dart';
import 'package:foss_wallet/src/screens/setup_2fa/setup_2fa_enter_code_page.dart';
import 'package:foss_wallet/src/screens/wallet/wallet_edit_page.dart';
import 'package:foss_wallet/themes/theme_list.dart';
import 'package:foss_wallet/utils/device_info.dart';
import 'package:foss_wallet/store/anonpay/anonpay_transactions_store.dart';
...
import 'package:foss_wallet/view_model/anon_invoice_page_view_model.dart';
import 'package:foss_wallet/view_model/anonpay_details_view_model.dart';
import 'package:foss_wallet/view_model/dashboard/receive_option_view_model.dart';
import 'package:foss_wallet/view_model/ionia/ionia_auth_view_model.dart';
import 'package:foss_wallet/view_model/ionia/ionia_buy_card_view_model.dart';
import 'package:foss_wallet/view_model/ionia/ionia_custom_tip_view_model.dart';
import 'package:foss_wallet/view_model/ionia/ionia_custom_redeem_view_model.dart';
import 'package:foss_wallet/ionia/ionia_service.dart';
import 'package:foss_wallet/ionia/ionia_api.dart';
...
import 'package:foss_wallet/src/screens/ionia/cards/ionia_account_cards_page.dart';
import 'package:foss_wallet/src/screens/ionia/cards/ionia_account_page.dart';
import 'package:foss_wallet/src/screens/ionia/cards/ionia_custom_tip_page.dart';
import 'package:foss_wallet/src/screens/ionia/ionia.dart';
import 'package:foss_wallet/src/screens/dashboard/widgets/balance_page.dart';
import 'package:foss_wallet/view_model/ionia/ionia_account_view_model.dart';
import 'package:foss_wallet/view_model/ionia/ionia_gift_cards_list_view_model.dart';
import 'package:foss_wallet/view_model/ionia/ionia_purchase_merch_view_model.dart';
...
import 'package:foss_wallet/view_model/settings/display_settings_view_model.dart';
import 'package:foss_wallet/view_model/settings/other_settings_view_model.dart';
import 'package:foss_wallet/view_model/settings/privacy_settings_view_model.dart';
...
import 'package:foss_wallet/src/screens/backup/backup_page.dart';
import 'package:foss_wallet/src/screens/backup/edit_backup_password_page.dart';
import 'package:foss_wallet/src/screens/buy/buy_webview_page.dart';
import 'package:foss_wallet/src/screens/buy/pre_order_page.dart';
import 'package:foss_wallet/src/screens/contact/contact_list_page.dart';
import 'package:foss_wallet/src/screens/contact/contact_page.dart';
import 'package:foss_wallet/src/screens/exchange_trade/exchange_confirm_page.dart';
import 'package:foss_wallet/src/screens/exchange_trade/exchange_trade_page.dart';
import 'package:foss_wallet/src/screens/faq/faq_page.dart';
import 'package:foss_wallet/src/screens/new_wallet/new_wallet_type_page.dart';
import 'package:foss_wallet/src/screens/nodes/node_create_or_edit_page.dart';
import 'package:foss_wallet/src/screens/order_details/order_details_page.dart';
import 'package:foss_wallet/src/screens/pin_code/pin_code_widget.dart';
import 'package:foss_wallet/src/screens/rescan/rescan_page.dart';
import 'package:foss_wallet/src/screens/restore/restore_from_backup_page.dart';
import 'package:foss_wallet/src/screens/restore/restore_options_page.dart';
import 'package:foss_wallet/src/screens/restore/wallet_restore_page.dart';
import 'package:foss_wallet/src/screens/seed/pre_seed_page.dart';
import 'package:foss_wallet/src/screens/seed/wallet_seed_page.dart';
import 'package:foss_wallet/src/screens/send/send_template_page.dart';
import 'package:foss_wallet/src/screens/setup_pin_code/setup_pin_code.dart';
import 'package:foss_wallet/src/screens/support/support_page.dart';
import 'package:foss_wallet/src/screens/trade_details/trade_details_page.dart';
import 'package:foss_wallet/src/screens/transaction_details/transaction_details_page.dart';
import 'package:foss_wallet/src/screens/unspent_coins/unspent_coins_details_page.dart';
import 'package:foss_wallet/src/screens/unspent_coins/unspent_coins_list_page.dart';
import 'package:foss_wallet/src/screens/wallet_keys/wallet_keys_page.dart';
import 'package:foss_wallet/src/screens/exchange/exchange_page.dart';
import 'package:foss_wallet/src/screens/exchange/exchange_template_page.dart';
import 'package:foss_wallet/store/dashboard/orders_store.dart';
import 'package:foss_wallet/store/node_list_store.dart';
...
import 'package:foss_wallet/src/screens/monero_accounts/monero_account_list_page.dart';
import 'package:foss_wallet/src/screens/monero_accounts/monero_account_edit_or_create_page.dart';
import 'package:foss_wallet/src/screens/auth/auth_page.dart';
import 'package:foss_wallet/src/screens/dashboard/dashboard_page.dart';
import 'package:foss_wallet/src/screens/receive/receive_page.dart';
import 'package:foss_wallet/src/screens/send/send_page.dart';
import 'package:foss_wallet/src/screens/subaddress/address_edit_or_create_page.dart';
import 'package:foss_wallet/src/screens/wallet_list/wallet_list_page.dart';
import 'package:foss_wallet/store/wallet_list_store.dart';
import 'package:foss_wallet/store/yat/yat_store.dart';
import 'package:foss_wallet/view_model/backup_view_model.dart';
...
import 'package:foss_wallet/view_model/edit_backup_password_view_model.dart';
import 'package:foss_wallet/view_model/exchange/exchange_trade_view_model.dart';
...
import 'package:foss_wallet/view_model/order_details_view_model.dart';
import 'package:foss_wallet/view_model/rescan_view_model.dart';
import 'package:foss_wallet/view_model/restore_from_backup_view_model.dart';
import 'package:foss_wallet/view_model/send/send_template_view_model.dart';
...
import 'package:foss_wallet/view_model/wallet_address_list/wallet_address_edit_or_create_view_model.dart';
import 'package:foss_wallet/view_model/auth_view_model.dart';
...
import 'package:foss_wallet/view_model/monero_account_list/monero_account_list_view_model.dart';
...
import 'package:foss_wallet/view_model/wallet_list/wallet_list_view_model.dart';
import 'package:foss_wallet/view_model/wallet_restore_view_model.dart';
import 'package:foss_wallet/view_model/wallet_seed_view_model.dart';
...
import 'package:foss_wallet/view_model/wallet_restoration_from_seed_vm.dart';
import 'package:foss_wallet/view_model/wallet_restoration_from_keys_vm.dart';
...
import 'package:foss_wallet/store/dashboard/trade_filter_store.dart';
import 'package:foss_wallet/store/dashboard/transaction_filter_store.dart';
...
import 'package:foss_wallet/store/templates/exchange_template_store.dart';
import 'package:foss_wallet/entities/template.dart';
import 'package:foss_wallet/exchange/exchange_template.dart';
import 'package:foss_wallet/.secrets.g.dart' as secrets;
import 'package:foss_wallet/src/screens/dashboard/widgets/address_page.dart';
import 'package:foss_wallet/anypay/anypay_api.dart';
import 'package:foss_wallet/view_model/ionia/ionia_gift_card_details_view_model.dart';
import 'package:foss_wallet/src/screens/ionia/cards/ionia_payment_status_page.dart';
import 'package:foss_wallet/view_model/ionia/ionia_payment_status_view_model.dart';
...
import 'package:foss_wallet/src/screens/receive/fullscreen_qr_page.dart';
