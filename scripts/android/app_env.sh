...
case $APP_ANDROID_TYPE in
	...
	$HAVEN)
		...
		;;
	$EW)
		APP_ANDROID_NAME=$EW_NAME
		APP_ANDROID_VERSION=$EW_VERSION
		APP_ANDROID_BUILD_NUMBER=$EW_BUILD_NUMBER
		APP_ANDROID_BUNDLE_ID=$EW_BUNDLE_ID
		APP_ANDROID_PACKAGE=$EW_PACKAGE
		;;
esac
